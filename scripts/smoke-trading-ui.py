...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        check(interactive_risk_charts.count() == 12, "Risk charts are not pointer and keyboard interactive")
        first_risk_chart = interactive_risk_charts.nth(1)
        first_risk_chart.hover(position={"x": 240, "y": 35})
        ...
        check("VIX" in tooltip_text and any(month in tooltip_text for month in ("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec")), "Risk tooltip is missing date/value context")
