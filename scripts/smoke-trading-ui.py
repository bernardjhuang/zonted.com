...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        check("formal peptide-action schedule" in hims_card.inner_text(), "HIMS FDA monitoring thesis is missing")
        check("below $25" in hims_card.inner_text(), "HIMS home-page price trigger is missing")
        check("next PCAC meeting date" in hims_card.inner_text(), "HIMS PCAC monitoring trigger is missing")
