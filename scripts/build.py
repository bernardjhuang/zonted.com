...
CURATED_RELATED = {
    ...
    "posts/introducing-autonomous-agent-paper-fund-ii-psy": ["posts/introducing-autonomous-agent-paper-fund-i-slo", "posts/vibe-trading", "posts/google-trends-stock-attention"],
    "posts/introducing-autonomous-agent-paper-fund-i-slo": ["posts/introducing-autonomous-agent-paper-fund-ii-psy", "posts/vibe-trading", "posts/google-trends-stock-attention"],
