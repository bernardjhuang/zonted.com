...
CURATED_RELATED = {
    ...
    "posts/retiring-autonomous-agent-paper-fund-ii": ["posts/introducing-autonomous-agent-paper-fund-ii-psy", "posts/introducing-autonomous-agent-paper-fund-i-slo", "posts/vibe-trading"],
    "posts/introducing-autonomous-agent-paper-fund-ii-psy": ["posts/retiring-autonomous-agent-paper-fund-ii", "posts/introducing-autonomous-agent-paper-fund-i-slo", "posts/vibe-trading"],
    "posts/introducing-autonomous-agent-paper-fund-i-slo": ["posts/introducing-autonomous-agent-paper-fund-ii-psy", "posts/retiring-autonomous-agent-paper-fund-ii", "posts/vibe-trading"],
