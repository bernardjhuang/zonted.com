...
- [Trading](https://zonted.com/trading/): Quantity-free position log — current holdings, recent large trades, research watchlist, and the [Grok brief](https://zonted.com/trading/grok-brief/) cross-agency catalyst scanner
...
CURATED_RELATED = {
    ...
    "posts/vibe-trading": ["posts/google-trends-stock-attention", "posts/back-to-the-tables", "posts/stakes-priming-surface-area"],
