...
class RiskJournalContractTest(unittest.TestCase):
    ...
    def test_grok_log_has_july_28_entry_and_current_rating(self) -> None:
        page = (ROOT / "trading" / "grok-risk" / "index.html").read_text()
        self.assertIn('data-model="Grok-4.3" data-rating="6" data-stance="Mildly risk-on / neutral-constructive"', page)
        self.assertIn("2026-07-28 · Neutral-Constructive (6/10)", page)
        self.assertIn("2026-07-27 · Risk On (6.5/10)", page)
        self.assertLess(page.index("2026-07-28"), page.index("2026-07-27"))
