...
class TradingUiContractTest(unittest.TestCase):
    ...
    def test_signal_vocabulary_is_preserved(self):
        ...
        qualified_longs = sum(row["signal"] in {"ENTER", "ENTER+"} for row in universe["rows"])
        self.assertEqual(universe["risk_decision_counts"]["annotate_watchful"], qualified_longs)
